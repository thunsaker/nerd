 ...
 */
public class NerdInjectingBroadcastReceiver
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mObjectGraph = ((NerdApp) context.getApplicationContext()).getObjectGraph().plus(getModules().toArray());
    ...
    protected List<Object> getModules() {
        ...
        result.add(new NerdInjectingBroadcastReceiverModule(mContext, this, this));
        return result;
    }

    /**
     * The dagger module associated with {@link NerdInjectingBroadcastReceiver}
     */
    @Module(library = true)
    public static class NerdInjectingBroadcastReceiverModule {
        Context mContext;
         ...
         */
        public NerdInjectingBroadcastReceiverModule(Context context, android.content.BroadcastReceiver receiver, Injector injector) {
            mContext = context;
            mReceiver = receiver;
            mInjector = injector;
        }
